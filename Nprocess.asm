...
{	
  ...
  13:	8b 41 04             	mov    0x4(%ecx),%eax
	int num=atoi(argv[1]);
  16:	ff 70 04             	pushl  0x4(%eax)
  19:	e8 22 02 00 00       	call   240 <atoi>
	for(int i=0;i<num;i++)
  1e:	83 c4 10             	add    $0x10,%esp
  21:	85 c0                	test   %eax,%eax
  23:	7e 2d                	jle    52 <main+0x52>
  25:	89 c6                	mov    %eax,%esi
  27:	31 db                	xor    %ebx,%ebx
  29:	eb 0c                	jmp    37 <main+0x37>
  2b:	90                   	nop
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  30:	83 c3 01             	add    $0x1,%ebx
  33:	39 de                	cmp    %ebx,%esi
  35:	74 1b                	je     52 <main+0x52>
	{
		if(fork()==0)
  ...
  43:	68 c8 00 00 00       	push   $0xc8
  48:	e8 f5 02 00 00       	call   342 <sleep>
			exit();
  4d:	e8 60 02 00 00       	call   2b2 <exit>
		}
	}
	//return 0;
	exit();
...
free(void *ap)
{
 ...
 601:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 3c 0a 00 00       	mov    %eax,0xa3c
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 757:	0a 00 00 
 75a:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 40 0a 00 00       	mov    $0xa40,%eax
 769:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 770:	00 00 00 
