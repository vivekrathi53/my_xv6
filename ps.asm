...
int main(int argc, char *argv[])
{
   ...
   f:	51                   	push   %ecx
	struct procList pl;	
	cps(&pl);
  10:	8d 85 a8 fe ff ff    	lea    -0x158(%ebp),%eax
  16:	8d 9d ac fe ff ff    	lea    -0x154(%ebp),%ebx
  1c:	8d 75 ec             	lea    -0x14(%ebp),%esi
{
  1f:	81 ec 58 01 00 00    	sub    $0x158,%esp
	cps(&pl);
  25:	50                   	push   %eax
  26:	e8 27 03 00 00       	call   352 <cps>
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	eb 07                	jmp    37 <main+0x37>
  30:	83 c3 20             	add    $0x20,%ebx
	for(int i=0;i<10;i++)
  33:	39 f3                	cmp    %esi,%ebx
  35:	74 20                	je     57 <main+0x57>
	{
		if(pl.p[i].pid!=0)
  37:	8b 03                	mov    (%ebx),%eax
  39:	85 c0                	test   %eax,%eax
  3b:	74 f3                	je     30 <main+0x30>
			printf(1,"%d\n",pl.p[i].pid);
  3d:	83 ec 04             	sub    $0x4,%esp
  40:	83 c3 20             	add    $0x20,%ebx
  43:	50                   	push   %eax
