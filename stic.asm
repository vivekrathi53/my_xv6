  ...
  2a:	83 c4 10             	add    $0x10,%esp
{
  ...
  40:	8b 56 04             	mov    0x4(%esi),%edx
  43:	83 ec 0c             	sub    $0xc,%esp
  46:	52                   	push   %edx
  47:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  4a:	e8 21 01 00 00       	call   170 <strlen>
  4f:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  52:	89 f9                	mov    %edi,%ecx
	for(int i=0;i<strlen(argv[1]);i++)
  ...
  5e:	0f be 04 0a          	movsbl (%edx,%ecx,1),%eax
  62:	83 e8 30             	sub    $0x30,%eax
  65:	0f af c3             	imul   %ebx,%eax
  68:	01 45 e0             	add    %eax,-0x20(%ebp)
		val*=10;
  6b:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  6e:	01 db                	add    %ebx,%ebx
	for(int i=0;i<strlen(argv[1]);i++)
  70:	83 ec 0c             	sub    $0xc,%esp
  73:	ff 76 04             	pushl  0x4(%esi)
  76:	e8 f5 00 00 00       	call   170 <strlen>
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	39 f8                	cmp    %edi,%eax
  80:	77 be                	ja     40 <main+0x40>
	}	
	val=1;
  ...
  84:	bb 01 00 00 00       	mov    $0x1,%ebx
	int pid=0,tickets=0;
  89:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
  90:	eb 36                	jmp    c8 <main+0xc8>
  92:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
	{
		tickets+=(argv[2][strlen(argv[2])-i-1]-'0')*val;
  98:	8b 56 08             	mov    0x8(%esi),%edx
  9b:	83 ec 0c             	sub    $0xc,%esp
  9e:	52                   	push   %edx
  9f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  a2:	e8 c9 00 00 00       	call   170 <strlen>
  a7:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  aa:	89 f9                	mov    %edi,%ecx
	for(int i=0;i<strlen(argv[2]);i++)
  ac:	83 c4 10             	add    $0x10,%esp
		tickets+=(argv[2][strlen(argv[2])-i-1]-'0')*val;
  af:	f7 d1                	not    %ecx
	for(int i=0;i<strlen(argv[2]);i++)
  b1:	83 c7 01             	add    $0x1,%edi
		tickets+=(argv[2][strlen(argv[2])-i-1]-'0')*val;
  b4:	01 c2                	add    %eax,%edx
  b6:	0f be 04 0a          	movsbl (%edx,%ecx,1),%eax
  ba:	83 e8 30             	sub    $0x30,%eax
  bd:	0f af c3             	imul   %ebx,%eax
  c0:	01 45 dc             	add    %eax,-0x24(%ebp)
		val*=10;
  c3:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  c6:	01 db                	add    %ebx,%ebx
	for(int i=0;i<strlen(argv[2]);i++)
  c8:	83 ec 0c             	sub    $0xc,%esp
  cb:	ff 76 08             	pushl  0x8(%esi)
  ce:	e8 9d 00 00 00       	call   170 <strlen>
  d3:	83 c4 10             	add    $0x10,%esp
  d6:	39 f8                	cmp    %edi,%eax
  d8:	77 be                	ja     98 <main+0x98>
	}
	setTickets(pid,tickets);
  da:	83 ec 08             	sub    $0x8,%esp
  dd:	ff 75 dc             	pushl  -0x24(%ebp)
  e0:	ff 75 e0             	pushl  -0x20(%ebp)
  e3:	e8 0a 03 00 00       	call   3f2 <setTickets>
	exit();
 ...
 429:	85 d2                	test   %edx,%edx
{
 ...
 457:	f7 f1                	div    %ecx
 459:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 674:	e9 8f fe ff ff       	jmp    508 <printf+0x48>
          s = "(null)";
 679:	bb 34 08 00 00       	mov    $0x834,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 691:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 6cd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6cf:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6d4:	5b                   	pop    %ebx
 6d5:	5e                   	pop    %esi
 6d6:	5f                   	pop    %edi
 ...
 6e6:	72 ce                	jb     6b6 <free+0x26>
{
 ...
 707:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 70a:	a3 ec 0a 00 00       	mov    %eax,0xaec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 47                	jae    7b8 <malloc+0x98>
    ...
    if(p == freep)
 771:	39 05 ec 0a 00 00    	cmp    %eax,0xaec
 ...
 796:	e8 f5 fe ff ff       	call   690 <free>
  return freep;
 79b:	8b 15 ec 0a 00 00    	mov    0xaec,%edx
 ...
 7c4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7c7:	89 15 ec 0a 00 00    	mov    %edx,0xaec
}
 ...
 7e7:	0a 00 00 
 7ea:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7f1:	0a 00 00 
    base.s.size = 0;
 7f4:	b8 f0 0a 00 00       	mov    $0xaf0,%eax
 7f9:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 800:	00 00 00 
